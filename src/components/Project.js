        ...
        <div className="col-md-12">
          <div className="row">
            <div className="project col-md-4">
              ...
              <div className="project__description-container col-md-10 col-md-offset-1">
                <p className="project__description">
                  Sound X is a Soundcloud Client built utilzing React, Redux and the Soundcloud API. Its features also include a dynamic search, endless
                  pagination, and a music player using HTML5.
                </p>
              </div>
            ...
            <div className="project col-md-4">
              ...
              <div className="project__description-container col-md-10 col-md-offset-1">
                <p className="project__description">
                  Dex is a Pokexdex of the original 151 Pokemon. It is a RESTFUl API written with Ruby On Rails with Postgresql as the database. The Front-End
          ...
          <div className="row">
            <div className="project col-md-4">
              ...
              <div className="project__description-container col-md-10 col-md-offset-1">
                <p className="project__description">
                  Material Bootstrap is a redesign of the pre-existing bootstrap components with a Material-UI inspired flair. It was written with SCSS.
                </p>
              </div>
              <div className="project__links-container col-md-6 col-md-offset-3">
                <a className="btn btn-default" href="https://github.com/nickharvey27/Material-Bootstrap">
                  Github
                </a>
              </div>
            </div>
            ...
            <div className="project col-md-4">
              <ProjectTitle title="Mouse Follow" />
              <div className="project__image-container col-md-12">
                <div className="project__image"> </div>
              </div>
              <div className="project__description-container col-md-10 col-md-offset-1">
                <p className="project__description">Mouse Follow is an example of how to use the Render Prop pattern in React.</p>
              </div>
              <div className="project__links-container col-md-6 col-md-offset-3">
                <a className="btn btn-default" href="https://github.com/nickharvey27/MouseFollow">
                  Github
                </a>
              </div>
            </div>
            ...
            <div className="project col-md-4">
              ...
              <div className="project__description-container col-md-10 col-md-offset-1">
                <p className="project__description">Github Flavored Markdown Previewer written with React.</p>
              </div>
              <div className="project__links-container col-md-6 col-md-offset-3">
                <a className="btn btn-default" href="https://github.com/nickharvey27/Github-Flavored-Markdown-Preview">
                  Github
                </a>
              </div>
            </div>
