      ...
      <div className="container">
        <div className="col-md-12">
          ...
          <div className="project col-md-4">
            ...
            <div className="project__description-container col-md-10 col-md-offset-1">
              <p className="project__description">
                Dex is a Pokexdex with the original 151 Pokemon. It is a RESTFUl API written with Ruby On Rails with Postgresql as the database. The Front-End
                is written with React. Dex is deployed on Heroku
              </p>
            </div>
            <div className="project__links-container col-md-6 col-md-offset-3">
