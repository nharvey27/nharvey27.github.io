        ...
        <div className="col-md-12">
          <div className="row">
            ...
            <div className="project col-md-4">
              ...
              <div className="project__description-container col-md-10 col-md-offset-1">
                <p className="project__description">
                  View top 50 cryptocurrencies price, market cap and 24 hour
            ...
            <div className="project col-md-4">
              ...
              <div className="project__description-container col-md-10 col-md-offset-1">
                <p className="project__description">
                  Dex is a Pokexdex of the original 151 Pokemon. It is a RESTFUl
                  API written with Ruby On Rails with Postgresql as the
                  database. The Front-End is written with React.
                </p>
              </div>
              <div className="project__links-container col-md-6 col-md-offset-3">
                <a
          ...
          <div className="row">
            <div className="project col-md-4">
              ...
              <div className="project__description-container col-md-10 col-md-offset-1">
                <p className="project__description">
                  Material Bootstrap is a redesign of the pre-existing bootstrap
                  components with a Material-UI inspired flair. It was written
                  with SCSS.
                </p>
              </div>
              <div className="project__links-container col-md-6 col-md-offset-3">
            ...
            <div className="project col-md-4">
              ...
              <div className="project__description-container col-md-10 col-md-offset-1">
                <p className="project__description">
                  ...
                  It is built with React, Redux and multiple other Javascript
